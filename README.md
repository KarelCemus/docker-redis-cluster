...
If the flag `-e "SENTINEL=true"` is passed there are 3 Sentinel nodes running on ports 5000 to 5003 matching standalone instances.

It also contains 3 standalone instances that is not part of the cluster. They are running on port 7006 to 7008
